...
variable "coreos_amis" {
  ...
  default = {
    ap-northeast-1  = "ami-93f2baf4"
    ap-southeast-1  = "ami-aacc7dc9"
    ap-southeast-2  = "ami-9db0b0fe"
    eu-central-1    = "ami-903df7ff"
    eu-west-1       = "ami-abcde0cd"
    sa-east-1       = "ami-c11573ad"
    us-east-1       = "ami-1ad0000c"
    us-gov-west-1   = "ami-e441fb85"
    us-west-1       = "ami-b31d43d3"
    us-west-2       = "ami-444dcd24"
  }
}
...
// for HA use 064104f8a3f01645a59d1cac1431e3a04c14b4ef
variable "dcos_provider_package_id" {
  description = "The late_bound_package_id for dcos"
  default = "d32e054e113b14d97841dd13b974a222976a8d62"
}

// for single master use
// dcos-config--setup_d32e054e113b14d97841dd13b974a222976a8d62
// dcos-metadata--setup_d32e054e113b14d97841dd13b974a222976a8d62

// for HA master use
// dcos-config--setup_064104f8a3f01645a59d1cac1431e3a04c14b4ef
// dcos-metadata--setup_064104f8a3f01645a59d1cac1431e3a04c14b4ef
...
variable "cluster_packages" {
  ...
  default = <<EOF
    [
      ...
      "toybox--0c49f879bfe2f99e6f99b397136894fa5096fa0c"
    ]EOF
}
